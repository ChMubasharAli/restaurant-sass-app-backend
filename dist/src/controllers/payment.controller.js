...
export class PaymentController {
    ...
    processPayment = async (req, res) => {
        const { orderId, cardNumber, expirationDate, cardCode, customerName, customerEmail, billingAddress, billingCity, billingState, billingZip, } = req.body;
     ...
     */
    processOpaquePayment = async (req, res) => {
        const { orderId, opaqueDataDescriptor, opaqueDataValue, customerName, customerEmail, } = req.body;
    ...
    processCOD = async (req, res) => {
        ...
        await this.paymentService.transactionService.createTransaction({
            orderId,
            paymentMethod: "COD",
            amount: Number(order.totalAmount),
            status: "PENDING",
