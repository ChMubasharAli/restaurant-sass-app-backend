...
import { adminLoginSchema, changePasswordSchema, } from "../validators/admin.validator.js";
...
export class AdminController {
    ...
    changePassword = async (req, res) => {
        ...
        const result = await this.adminService.changePassword(adminId, currentPassword, newPassword, confirmPassword);
        res.json({
            status: "success",
            data: result,
        });
