...
export class OrderRepository extends BaseRepository {
                ...
                data: {
                    ...
                    orderItems: {
                        create: data.items.map((item) => ({
                            ...
                            unitPrice: 0, // Will be updated after fetching menu item prices
                            totalPrice: 0, // Will be updated after fetching menu item prices
                        })),
                    },
                },
                include: {
    ...
    async updateOrderItemPrices(orderId, items) {
        try {
