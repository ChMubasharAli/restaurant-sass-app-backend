...
router.get("/availability", asyncHandler(reservationController.checkAvailability));
// Admin routes
...
router.get("/schedule", asyncHandler(reservationController.getReservationSchedule));
...
router.patch("/:id/accept", asyncHandler(reservationController.acceptReservation));
router.patch("/:id/reject", asyncHandler(reservationController.rejectReservation));
